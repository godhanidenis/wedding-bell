...
import Filter from '../../components/Filters/ProductFilters';
import UpperFilter from '../../components/Filters/ProductFilters/UpperFilter';
            ...
            <div className=" px-4  xl:px-64">
                <div className="rounded-md shadow-md bg-[#F5F5F5] p-4">
                    ...
                    <div className='mt-16 flex justify-end'>
                        <button className='bg-colorPrimary text-white font-bold p-2 rounded-md' onClick={() => { }}>see branches</button>
                    </div>
                </div>
                <div class="grid grid-cols-4 gap-4 mt-6">
                    <div className='bg-[#F5F5F5] rounded-md p-4 text-center'>
                        <p className='text-colorPrimary font-bold'>TOTAL PRODUCTS</p> <p className=' text-balck font-bold text-center'>25</p>
                    </div>
                    <div className='bg-[#F5F5F5] rounded-md p-4 text-center'>
                        <p className='text-colorPrimary font-bold'>SHARE</p> <p className=' text-balck font-bold text-center'>25</p>
                    </div>
                    <div className='bg-[#F5F5F5] rounded-md p-4 text-center'>
                        <p className='text-colorPrimary font-bold'>REVIEWS</p> <p className=' text-balck font-bold text-center'>{shopInfo.shopReviewCount}</p>
                    </div>
                    <div className='bg-[#F5F5F5] rounded-md p-4 text-center'>
                        <p className='text-colorPrimary font-bold'>FOLLOWERS</p> <p className=' text-balck font-bold text-center'>{shopInfo.shopFollowerCount}</p>
                    </div>
                </div>
            </div>
                ...
                <div className="rounded-md shadow-md  mx-2 mt-2" >
                    <div class="flex gap-7">
                        <div class="w-1/2 bg-colorPrimary p-4 rounded-md">
                            <div className='flex justify-between'>
                                <p className="text-lg font-bold text-white">Rating + Distrbushion</p>
                        ...
                        <div class="w-1/2 p-4 rounded-md">
                            ...
                            <div className='flex justify-end gap-6 mt-4'>
                                <button className='bg-colorPrimary text-white font-bold p-2 rounded-md' onClick={() => { }}>Add photo</button>
                                <button className='bg-colorPrimary text-white font-bold p-2 rounded-md' onClick={() => { }}>Submit Review</button>
                            </div>
                        </div>
                    </div>
                </div>
